...
module.exports = {
	...
	theme: {
		extend: {
			backgroundImage: {
				"hero-pattern":
					"linear-gradient(0deg, rgba(225,225,225,0.75) 0%, rgba(225,225,225,0.75) 100%), url('https://media.blogto.com/uploads/2017/07/14/20170714-oneeighty.jpg?cmd=resize&quality=70&w=1400&height=2500')",
